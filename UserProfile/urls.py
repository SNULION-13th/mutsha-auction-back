...
from .views import (SignUpView, SignInView, SignOutView, TokenRefreshView, UserProfileListView, 
KakaoSignInCallbackView, UserProfileDetailView, CheckUsernameView, RemainingPointDeductView)
