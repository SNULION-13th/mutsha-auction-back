...
def set_token_on_response_cookie(user, status_code) -> Response:
    ...
    res.set_cookie(
        "refresh_token", value=str(token), httponly=False, samesite="Lax", secure=False
    )
    res.set_cookie(
        "access_token",
...
class UserProfileDetailView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: UserProfileSerializer,
            400: "[profilepic_id, nickname] fields missing.",
            401: "please signin",
            404: "UserProfile Not found.",
        },
        manual_parameters=[
    ...
    def put(self, request):
        ...
        try:
            ...
            if not profilepic_id or not nickname:
                return Response(
                    {"detail": "[profilepic_id, nickname] fields missing."},
...
class RemainingPointDeductView(APIView):
    @swagger_auto_schema(
        ...
        responses={
            200: UserProfileSerializer,
            400: "point_to_deduct field missing.",
            401: "please signin",
            404: "UserProfile Not found.",
        },
        manual_parameters=[
    ...
    def put(self, request):
        ...
        try:
            ...
            if not point_to_deduct:
                return Response(
                    {"detail": "point_to_deduct field missing."},
                    status=status.HTTP_400_BAD_REQUEST,
                )
